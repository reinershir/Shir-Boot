...
Shir-Boot快速开发平台，整合了后台管理系统常用功能、国际化、在线代码生成、AI对话、AI开发工具（AI工具待开发中..） 等
...
6. 确保redis是可用的
7. 运行`ShirBootApplication.java` 启动后台服务
...
INSERT INTO `menu` (`ID`, `NAME`, `URL`, `ICON`, `PERMISSION_CODES`, `DESCRIPTION`, `LEFT_VALUE`, `RIGHT_VALUE`, `LEVEL`, `PROPERTY`, `CREATE_DATE`, `UPDATE_DATE`) VALUES
	...
	(17, 'AI Chat', '/development/chat', 'el-icon-chat-round', NULL, NULL, 32, 33, 2, 'menu', '2023-12-06 11:26:10', '2023-12-06 11:40:01');
