...
public class AccessTokenService {
    ...
    public void init() throws Exception {
        ...
        if (maxTryTimes <= 0) {
            log.error("fail to get accessToken from remote, try 3 times, please check your appKey" +
                    " and appSecret");
        }
    }
    ...
    private Boolean refreshAccessToken() {
        ...
        try {
            ...
            accessToken.setExpireTimestamp(System.currentTimeMillis() + body.expireIn * 2000);
